...
CREATE TABLE `bill` (
  ...
  `treatment_amount` varchar(45) DEFAULT NULL,
  `ward_type` varchar(45) DEFAULT NULL,
  `ward_rate` varchar(45) DEFAULT NULL,
...
INSERT INTO `bill` VALUES (1,1,'S. Kumar','TW','General Consultation','500','Single Seater','2000','2');
